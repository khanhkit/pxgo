...
### Fixed
- Support strict `ascii` / `us-ascii` PAC decoding so HTTP `Content-Type: charset=ascii` follows upstream Px v0.12 priority semantics, including failing on non-ASCII bytes instead of silently falling back to BOM/auto detection
...
[Unreleased]: https://github.com/khanhkit/pxgo/compare/v0.7.1...HEAD
[0.7.1]: https://github.com/khanhkit/pxgo/compare/v0.7.0...v0.7.1

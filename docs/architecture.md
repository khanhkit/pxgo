...
10. Kerberos ticket lifecycle utilities live in `internal/kerberos`; they do not currently constitute Unix upstream GSSAPI proxy authentication. Windows upstream Negotiate/NTLM is owned separately by SSPI code in `internal/proxy`.
